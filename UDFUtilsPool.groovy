import com.sap.it.api.mapping.*;
	...
	def String hasValue (String value){
	...
	def String hasOneOfSuchValues (String value, String suchValuesString){
...
def String containsSuchValue(String value, String suchValueString){
    ...
    if (value.contains(suchValueString)) {
        output = "true"
    } else {
        output = "false"
    }
...
def String fillUpToLength(String value, String padding, int length){
